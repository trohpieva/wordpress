...
<div class="panel-wrap product_data">
	...
	<span class="type_box hidden"> &mdash;
		<label for="product-type">
			<select id="product-type" name="product-type">
				<optgroup label="<?php esc_attr_e( 'Product Type', '' ); ?>">
	...
	<ul class="product_data_tabs wc-tabs">
		...
		<?php endforeach; ?>
		<?php do_action( '_product_write_panel_tabs' ); ?>
	</ul>

	<?php
		self::output_tabs();
		self::output_variations();
		do_action( '_product_data_panels' );
		wc_do_deprecated_action( '_product_write_panels', array(), '2.6', 'Use _product_data_panels action instead.' );
	?>
	<div class="clear"></div>
</div>
